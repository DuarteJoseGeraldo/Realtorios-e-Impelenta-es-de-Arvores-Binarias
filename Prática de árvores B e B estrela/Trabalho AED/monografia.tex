...
% ---
\titulo{Arvores Binária: Inserção e Busca}
\autor{José Geraldo Duarte Júnior \\ Pedro Arthur Diniz Freitas \\ Raphael Gomes Wagner}
\local{Timóteo}
\data{2022}
...
\preambulo{Lista 7 de Algoritmos e Estrutura de Dados sobre Arvores do tipo B e B*, no curso de Engenharia de Computação no Centro Federal de Educação Tecnológica de Minas Gerais}
...
Agradeço a todos pela dedicação por terem passado em AED I comigo..
