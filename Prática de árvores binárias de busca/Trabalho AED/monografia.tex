...
\autor{Raphael Gomes Wagner e José Geraldo Duarte Junior}
\local{Timóteo}
\data{2022}
...
\preambulo{Trabalho 3 de Algoritmos e Estrutura de Dados sobre Polias, Roldanas e Atrito no curso de Engenharia de Computação no Centro Federal de Educação Tecnológica de Minas Gerais}
