...
% ---
\titulo{lista 1 - aed ii\\ Polias, roldanas e atrito }
...
Agradeço ao responde ai por me passar em disciplinas até aqui.

Agradeço aos professores que não dão prova.

Agradeço a Dona Maria de Lurdes.
...
\begin{epigrafe}
    \vspace*{\fill}
	\begin{flushright}
		\textit{``Camarão que dorme \\a onda leva''.\\
		Zeca Pagodinho}
	\end{flushright}
\end{epigrafe}
